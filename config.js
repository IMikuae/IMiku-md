...
global.pdana = '081806369588'
global.pgopay = '081806369588'
global.psaweria = '-' 
...
global.packname = 'IMiku - MD by'
global.author = '© IMiku'
global.wm = '© IMiku'
global.stickpack = 'IMiku - MD by'
global.stickauth = '© IMiku'
global.fotonya = 'https://telegra.ph/file/edc03ab2e6825472d5ea4.jpg'
global.povo = 'IMiku'
global.eror = 'Terjadi Kesalahan Coba Lagi Nanti!'
global.multiplier = 69 
global.nomorbot = '6285752615023' 
global.nomorwa = '6281806369588'
global.namebot = '༄ᶜIMiku Botz☆࿐™'
global.tautanwa = 'https://api.whatsapp.com/send?phone=+6281806369588' 
global.owner = [
['6281806369588', '❦ ༄ᶜIMiku Botz☆🎐' ,true]
]
global.domain = 'https://fallxdomain.zrillhosting.xyz' // Isi Domain Lu
global.apikey = 'ptla_AFBbvK52IjBjXSfI2AH6WLMhPJZ107upNZUyLKKTXu1' // Isi Apikey Plta Lu
global.capikey = 'ptlc_ZhGv7c4oJY3ZHWU3sApFJv9IWHMQNmMNXA9121gVKst' // Isi Apikey Pltc Lu
...
global.APIKeys = { 
  "https://api.xyroinee.xyz": "QNkkkTo8lj",
...
global.wm = ' 「  ༄ᶜIMiku Botz☆࿐  」' 
global.namedoc = ' ༄ᶜIMiku Botz☆࿐' 
global.botdate = `⫹⫺ Day's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = '🎋IMiku ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
global.emojis = pickRandom(["👑", "🎗", "️🗿", "🕹", "️💡", "🪄", "🎈", "🎊", "🔖", "📍", "❤", "‍🔥", "💤", "💭", "🕚", "💬", "🚩", "🎐", "🍃", "🌿", "🥀", "✨", "⚡", "☂️"])


/*============== LOGO ==============*/
global.thumb = 'https://telegra.ph/file/d9be3b11f948d1fc5dd81.jpg' //Main Thumbnail
global.thumb2 = 'https://telegra.ph/file/18e367c67e13908302689.jpg'
global.thumbbc = 'https://telegra.ph/file/d9be3b11f948d1fc5dd81.jpg' //For broadcast
