...
let handler = async (m, { conn, command, usedPrefix, args }) => {
    ...
    if (value === "create") {
        ...
        await conn.reply(m.chat, "*⌂ W E R E W O L F - G A M E*\n\nGame telah dimulai, para player akan memerankan perannya masing masing, silahkan cek chat pribadi untuk melihat role kalian. Berhati-hatilah para warga, mungkin malam ini adalah malah terakhir untukmu", 'W E R E - W O L F', m)
